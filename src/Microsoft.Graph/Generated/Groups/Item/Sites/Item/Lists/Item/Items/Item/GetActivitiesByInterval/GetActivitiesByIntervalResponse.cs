...
namespace Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.Items.Item.GetActivitiesByInterval {
    public class GetActivitiesByIntervalResponse : BaseCollectionPaginationCountResponse, IAdditionalDataHolder, IBackedModel, IParsable {
...
#nullable restore
        ...
        /// </summary>
        public GetActivitiesByIntervalResponse() : base() {
