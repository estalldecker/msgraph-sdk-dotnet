...
namespace Microsoft.Graph.Models {
    public class X509CertificateAuthenticationMethodConfigurationCollectionResponse : BaseCollectionPaginationCountResponse, IAdditionalDataHolder, IBackedModel, IParsable {
...
#nullable enable
        public List<X509CertificateAuthenticationMethodConfiguration>? Value {
            get { return BackingStore?.Get<List<X509CertificateAuthenticationMethodConfiguration>?>("value"); }
...
#nullable restore
        ...
        /// </summary>
        public X509CertificateAuthenticationMethodConfigurationCollectionResponse() : base() {
