...
namespace Microsoft.Graph.Models {
    public class MultiValueLegacyExtendedPropertyCollectionResponse : BaseCollectionPaginationCountResponse, IAdditionalDataHolder, IBackedModel, IParsable {
...
#nullable enable
        public List<MultiValueLegacyExtendedProperty>? Value {
            get { return BackingStore?.Get<List<MultiValueLegacyExtendedProperty>?>("value"); }
...
#nullable restore
        ...
        /// </summary>
        public MultiValueLegacyExtendedPropertyCollectionResponse() : base() {
        ...
        public static new MultiValueLegacyExtendedPropertyCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
