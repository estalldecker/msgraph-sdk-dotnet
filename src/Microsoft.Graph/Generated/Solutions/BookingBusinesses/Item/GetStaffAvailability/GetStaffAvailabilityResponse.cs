...
namespace Microsoft.Graph.Solutions.BookingBusinesses.Item.GetStaffAvailability {
    public class GetStaffAvailabilityResponse : BaseCollectionPaginationCountResponse, IAdditionalDataHolder, IBackedModel, IParsable {
...
#nullable restore
        ...
        /// </summary>
        public GetStaffAvailabilityResponse() : base() {
