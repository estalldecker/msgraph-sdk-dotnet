...
namespace Microsoft.Graph.Me.GetManagedAppDiagnosticStatuses {
    public class GetManagedAppDiagnosticStatusesResponse : BaseCollectionPaginationCountResponse, IAdditionalDataHolder, IBackedModel, IParsable {
...
#nullable enable
        public List<ManagedAppDiagnosticStatus>? Value {
            get { return BackingStore?.Get<List<ManagedAppDiagnosticStatus>?>("value"); }
...
#nullable restore
        ...
        /// </summary>
        public GetManagedAppDiagnosticStatusesResponse() : base() {
        ...
        public static new GetManagedAppDiagnosticStatusesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
