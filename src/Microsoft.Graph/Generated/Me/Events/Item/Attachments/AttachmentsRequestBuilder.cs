using Microsoft.Graph.Me.Events.Item.Attachments.Count;
using Microsoft.Graph.Me.Events.Item.Attachments.CreateUploadSession;
using Microsoft.Graph.Me.Events.Item.Attachments.Item;
...
namespace Microsoft.Graph.Me.Events.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        public AttachmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/events/{event%2Did}/attachments{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
