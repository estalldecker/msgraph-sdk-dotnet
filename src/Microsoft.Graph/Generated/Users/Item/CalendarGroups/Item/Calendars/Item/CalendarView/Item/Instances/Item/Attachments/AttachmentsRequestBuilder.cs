...
using Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Instances.Item.Attachments.Count;
using Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Instances.Item.Attachments.CreateUploadSession;
using Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Instances.Item.Attachments.Item;
...
namespace Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Instances.Item.Attachments {
    /// <summary>
    ...
    public class AttachmentsRequestBuilder {
        ...
        public AttachmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/attachments{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
