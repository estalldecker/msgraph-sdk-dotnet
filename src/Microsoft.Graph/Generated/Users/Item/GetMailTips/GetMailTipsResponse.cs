...
namespace Microsoft.Graph.Users.Item.GetMailTips {
    public class GetMailTipsResponse : BaseCollectionPaginationCountResponse, IAdditionalDataHolder, IBackedModel, IParsable {
...
#nullable enable
        public List<MailTips>? Value {
            get { return BackingStore?.Get<List<MailTips>?>("value"); }
...
#nullable restore
        ...
        /// </summary>
        public GetMailTipsResponse() : base() {
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"value", n => { Value = n.GetCollectionOfObjectValues<MailTips>(MailTips.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
